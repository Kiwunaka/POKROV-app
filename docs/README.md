...
- `marketing` owns public acquisition, `webapp` owns browser continuation, and the client shell stays locked to `Подключение / Локации / Правила / Профиль`
...
The shared shell also models the app-first UX basics for the consumer-first tab set `Подключение / Локации / Правила / Профиль`, plus route mode, redeem, checkout handoff, support, and location matrices.
