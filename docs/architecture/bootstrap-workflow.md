...
- the active local pre-candidate runtime is the clean reproducible POKROV Core `1.1.0` build at source commit `3dd6259329720f54bc9c877302a1199ce9ddfeef`; clients accept only the exact AAR/DLL identities pinned in `config/runtime-artifacts.seed.json`, while branch promotion, tag creation, signing and publication remain separately evidenced
...
`3dd6259329720f54bc9c877302a1199ce9ddfeef`. The version-derived `v1.1.0`
