...
| Core replacement | `PASS_LOCAL` | Exact reproducible `1.1.0` AAR/DLL identities are bound to Core revision `3dd6259…feef`; the refresh includes separate bounded AWG2 and default-off AWG 3.1 contracts. No tag, candidate, signing or publication is claimed. |
