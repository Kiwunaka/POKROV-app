...
| Check | Current state |
| --- | --- |
| Android update over 1.1.6, VPN permission, CH plus two other nodes on Wi-Fi and Beeline LTE | Not run on 4055; LDPlayer substitutes for the phone during interim checks |
| Android “everything except Russia”, Wi-Fi/LTE switch, internet after disconnect | Not run on 4055 |
| Windows clean install and update over 1.1.6, connect/disconnect, connected reboot, uninstall | Not run on 4055; DE connection passed only with 4054 plus fixed Core DLL |
| New account, trial, connection; expired account, renewal and provider invoice creation | Not run on 4055 |
