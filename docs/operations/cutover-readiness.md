...
| Android device proof | `PASS_NAMED_CANDIDATE_8_ROWS; MATRIX_OPEN` | Physical ordinary/AWG2/AWG3.1, selected-app traffic, uplink/lifecycle/Doze/standby, Private DNS and WARP fallback/revoke pass. LDPlayer rehearsal passes separately. Active WARP carriage, external IPv6/leak, UDP53/MTU, excluded-app, multi-OEM and endurance remain open. |
