# Retained responsive capture-plan snapshot

Document class: `EVIDENCE`
Snapshot date: 2026-08-22

This file preserves the exact responsive-plan text that still named the
superseded `1.0.0-beta` line before `WO-003G` bound the active plan to `1.2.0`.
It is not the current release decision and cannot authorize a new candidate or promotion.
