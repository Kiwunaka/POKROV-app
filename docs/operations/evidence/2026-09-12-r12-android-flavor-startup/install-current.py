...
old='baa5202957c46e9ba92e3fff4c46418b60ff309311cfa015aef86da685ac0f52'
...
retained=json.loads(Path('C:/r12-support-build-packages-20260912/prior-packages.json').read_bytes());assert any(x['sha256']==old for x in retained['artifacts'])
