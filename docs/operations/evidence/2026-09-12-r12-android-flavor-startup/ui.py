...
if __name__=='__main__':
 ...
 if sys.argv[1]=='start':
  path=run('shell','pm','path',pkg).decode().strip().removeprefix('package:');assert run('shell','sha256sum',path).decode().split()[0]=='23fa86a9421930910e6d95d0fdff85f35c5df4e94f8749b83e3457052b66935d';run('shell','am','start','-n',pkg+'/.MainActivity')
 elif sys.argv[1]=='tap':
