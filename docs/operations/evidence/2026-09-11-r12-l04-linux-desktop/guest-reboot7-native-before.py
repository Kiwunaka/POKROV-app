...
r=pathlib.Path('/home/pokrovqa/acceptance-inputs');out=r/'candidate7-reboot-native.json';assert not out.exists()
...
digest=r/'reboot7-native-profile-digest';assert not digest.exists();digest.write_text(profile_before);digest.chmod(0o600)
