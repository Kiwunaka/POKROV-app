...
r=pathlib.Path('/home/pokrovqa/acceptance-inputs');out=r/'candidate7-reboot.json'
...
try:
 ...
 result['profile_bytes_unchanged']=hashlib.sha256(profile.read_bytes()).hexdigest()==(r/'reboot7-profile-digest').read_text();assert result['profile_bytes_unchanged']
