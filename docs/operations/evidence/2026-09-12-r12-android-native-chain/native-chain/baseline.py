...
if __name__=='__main__':
 ...
 path=ui.run('shell','pm','path',ui.pkg).decode().strip().removeprefix('package:');apk=ui.run('shell','sha256sum',path).decode().split()[0];assert apk=='8dc6c2e6671b7ea3d2331c1ec31c5a788458fd10de9dd9a9693abfcd8eab62ad'
