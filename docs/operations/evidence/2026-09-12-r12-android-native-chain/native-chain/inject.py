...
markers={'credential':'password=R12_ANDROID_CREDENTIAL_2c_20260912','authorization':'Authorization: Bearer R12_ANDROID_AUTH_2c_20260912','cookie':'Cookie: session=R12_ANDROID_COOKIE_2c_20260912','config':'config={private_key:R12_ANDROID_CONFIG_2c_20260912}','url':'https://example.invalid/R12_ANDROID_URL_2c_20260912?secret=synthetic','ipv4':'198.51.100.127','path':'/data/user/0/synthetic/R12_ANDROID_PATH_2c_20260912.conf','pii':'qa+R12_ANDROID_PII_2c_20260912@example.invalid','provider':'provider_payload=R12_ANDROID_PROVIDER_2c_20260912'}
...
if __name__=='__main__':
 ...
 backup=b.private+'/files/r12-private-rollback-2c-chain-20260912'
