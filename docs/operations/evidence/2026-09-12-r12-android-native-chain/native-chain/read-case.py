...
with SessionLocal() as s:
 for case in [64]:
  t=s.get(SupportTicket,case);assert t and t.created_at>=dt.datetime(2026,9,12,7,46)
 ...
 p=s.query(SupportModePolicy).filter_by(policy_id='spol-be05167034c24d2b80712b3b',ticket_id=58).one()
