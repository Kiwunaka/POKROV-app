...
if __name__=='__main__':
 ...
 if sys.argv[1]=='start':
  path=run('shell','pm','path',pkg).decode().strip().removeprefix('package:');assert run('shell','sha256sum',path).decode().split()[0]=='8dc6c2e6671b7ea3d2331c1ec31c5a788458fd10de9dd9a9693abfcd8eab62ad';run('shell','am','start','-n',pkg+'/.MainActivity')
 elif sys.argv[1]=='tap':
