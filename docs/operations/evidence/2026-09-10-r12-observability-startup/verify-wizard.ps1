...
$dir='C:/Users/Public/R12ObservabilityStartup'
...
if(-not ([IO.File]::ReadAllText("$dir/wizard.log").Contains('Installation process succeeded.'))){throw 'Wizard completion not observed'}
