...
import ctypes as c
import hashlib, json, socket, struct, threading, time, runpy
...
fixture = root / 'artifact-loopback-fixture-v2'
fixture.mkdir()
...
(root / 'artifact-lifecycle-v2.json').write_text(json.dumps(receipt, indent=2) + '\n', encoding='utf8')
origin.close()
