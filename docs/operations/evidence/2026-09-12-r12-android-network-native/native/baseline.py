...
if __name__=='__main__':
 ...
 path=ui.run('shell','pm','path',ui.pkg).decode().strip().removeprefix('package:');apk=ui.run('shell','sha256sum',path).decode().split()[0];assert apk=='baa5202957c46e9ba92e3fff4c46418b60ff309311cfa015aef86da685ac0f52'
