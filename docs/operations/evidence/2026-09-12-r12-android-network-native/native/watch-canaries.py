...
(out/'canary-ldplayer-before.json').write_text(json.dumps(r,indent=2)+'\n')
...
while True:
    ...
    if elapsed-last>=5:
        ...
        (out/'canary-ldplayer-progress.json').write_text(json.dumps(r,indent=2)+'\n')
...
(out/'canary-restoration.json').write_text(json.dumps(r,indent=2)+'\n')
