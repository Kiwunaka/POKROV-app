...
CIPHER_SHA = '84ac7f0d727f9da2a34b59c96b98ef016df7fbc374d2de2795c2456753426636'
...
def guard(s):
    ...
    assert ticket and ticket.created_at >= dt.datetime(2026, 9, 12, 7, 6)
...
try:
    ...
    for item in payload['files']:
        ...
        if item['path'] == 'events/operational.jsonl':
    ...
    assert {f['path'] for f in files} == {'build/identity.json', 'network/summary.json', 'redaction/report.json', 'events/operational.jsonl', 'system/summary.json'}
