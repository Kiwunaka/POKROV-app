...
old='6d4b998756548c980937a1f9de7af39a1d65899ec06319594073daceab993e63'
...
retained=json.loads(Path('C:/r12-psm-consent-packages-20260912/prior-package-retention.json').read_bytes());assert any(x['sha256']==old for x in retained['artifacts'])
