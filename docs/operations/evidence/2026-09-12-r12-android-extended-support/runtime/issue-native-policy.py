...
prefix=prefix.replace("try:\n with SessionLocal()", "private_state=pathlib.Path('/root/portal-r12-evidence/psm-runtime-20260910/android-policy-private-20260912-v2.json');assert not private_state.exists()\ntry:\n with SessionLocal()")
body=r'''
