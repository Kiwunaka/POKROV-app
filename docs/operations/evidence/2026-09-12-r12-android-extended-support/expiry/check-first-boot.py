...
out=Path('C:/r12-psm-autoexpiry-20260912');adb='C:/Users/kiwun/AppData/Local/Android/Sdk/platform-tools/adb.exe';r=subprocess.run([adb,'-s','emulator-5560','shell','getprop','sys.boot_completed'],capture_output=True,timeout=15)
