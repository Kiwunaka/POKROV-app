...
assert json.loads((base / 'wintun-fix-20260912/progress.json').read_text())['status'] == 'PASS'
assert json.loads((base / 'wintun-fix-20260912/build-progress.json').read_text())['status'] == 'PASS_EXACT_SOURCE_BUILD'
