...
r=pathlib.Path('/home/pokrovtest/r12-l02');archive=r/'linux-client-361b0e4.tar.gz';dest=r/'l04-client-361b0e4'
assert hashlib.sha256(archive.read_bytes()).hexdigest()=='517db9550c196cd681d01c9952c5cc709ed9da1e1de6b4965368a9091c42cc3b'
assert __import__('shutil').disk_usage(r).free>1024**3
dest.mkdir()
...
(r/'l04-client-build-10.json').write_text(json.dumps(receipt,indent=2)+'\n')
