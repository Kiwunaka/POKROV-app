...
$root='C:/r12-c05-setup-privacy-20260912/packaged-ffi/V01_CANARY_SETUP_PATH'
...
$start.Arguments='-NoProfile -ExecutionPolicy Bypass -File C:/r12-c05-setup-privacy-20260912/packaged-ffi/V01_CANARY_SETUP_PATH/child.ps1'
...
$result=[ordered]@{utc=[DateTime]::UtcNow.ToString('o');status=if($leaked){'FAIL_PRIVACY'}else{'PASS_BOUNDED_PACKAGED_DLL_FFI'};origin='current-origin host isolated subprocess; invalid config before service startup; no TUN';client_source='2aa57015783ceb3415e3be62bbf0a698729011c4';core_source='6b271decead88b708e2fc03984b703b0a4e63ebd';packaged_dll_path='E:/r12client/apps/windows_shell/build/release_bundle/pokrov-windows-x64-1.2.0+4053/pokrov-core.dll';child=$child;sinks=$sinks;raw_streams_retained=$false;host_network_changed=$false;live_profile_used=$false}
