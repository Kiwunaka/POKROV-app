...
$taskRoots = @('E:\r12-c05-package-artifacts','E:\r12-c05-artifacts','E:\r12-artifacts')
...
@{status='PREPARED_EXACT_PRIOR_ARTIFACT_COMPRESSION';roots=$taskRoots;files=$taskRows.ToArray();free_e_before=$taskBefore;method='NTFS native compression; no file removal or content edits'}|ConvertTo-Json -Depth 6|Set-Content "$taskOut/prior-artifact-compression-plan.json"
...
$taskResult|ConvertTo-Json|Set-Content "$taskOut/prior-artifact-compression.json"
