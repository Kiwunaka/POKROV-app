...
source = work / 'source'
baseline = base / 'wintun-final-880b-20260912'
...
result = {'status': 'RUNNING', 'source_commit': progress['source_commit'], 'source_tree': progress['source_tree'], 'baseline_source': '880bff65ad665844828fe50fc395e9cfc1cd81b4', 'binaries': [], 'errors': []}
