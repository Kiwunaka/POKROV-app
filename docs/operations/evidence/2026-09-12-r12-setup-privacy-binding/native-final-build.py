...
revision = '6b271decead88b708e2fc03984b703b0a4e63ebd'
assert manifest['source_commit'] == revision
assert json.loads((base / 'setup-privacy-20260912/progress.json').read_text())['status'] == 'PASS'
