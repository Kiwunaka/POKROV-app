...
out = Path('C:/r12-dart-crash-packages-20260912')
...
assert b'f7115c505c314a7322481997a46343b03dae1127' in (bundle/'data/app.so').read_bytes(), 'Current Dart revision absent'
...
result = {'schema': 'pokrov.r12.final-windows-package-audit/v1',
          'source_client': 'f7115c505c314a7322481997a46343b03dae1127', 'source_core': '6b271decead88b708e2fc03984b703b0a4e63ebd',
