...
report = {'status': 'PASS_FOUR_EXACT_DIRECT_APKS', 'source_client': source, 'source_core': seed['source_commit'], 'utc': datetime.datetime.now(datetime.timezone.utc).isoformat(), 'artifacts': artifacts, 'aab': 'PENDING_STORE_PHASE', 'device_install': 'NOT_PERFORMED_CURRENT_APKS'}
