...
assert source == 'f7115c505c314a7322481997a46343b03dae1127'
assert json.loads((Path('C:/r12-dart-crash-promotion-20260912/client-candidate.json')).read_bytes())['source']==source
floor=40*2**30
...
result={'status':'RUNNING','source':source,'core':'6b271decead88b708e2fc03984b703b0a4e63ebd','utc':datetime.datetime.now(datetime.timezone.utc).isoformat(),'floor_bytes':floor,'abort_margin':256*2**20,'estimated_incremental_windows_budget_bytes':512*2**20,'previous_windows_output_bytes':255375313,'prior_outputs_retained':True,'skipped_build_script_checks':'Current crash test8 analyze seed/docs and exact PR CI passed; native CTest separate','samples':[]}
