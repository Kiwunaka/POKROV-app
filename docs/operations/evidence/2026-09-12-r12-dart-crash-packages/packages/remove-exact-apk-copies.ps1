...
if ($taskRecord.status -ne 'PASS_FOUR_EXACT_DIRECT_APKS' -or $taskRecord.artifacts.Count -ne 4 -or $taskRecord.source_client -ne 'f7115c505c314a7322481997a46343b03dae1127') { throw 'Unexpected APK proof' }
