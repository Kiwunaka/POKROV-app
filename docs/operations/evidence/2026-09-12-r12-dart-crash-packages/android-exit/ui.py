...
if __name__=='__main__':
 ...
 if sys.argv[1]=='start':
  path=run('shell','pm','path',pkg).decode().strip().removeprefix('package:');assert run('shell','sha256sum',path).decode().split()[0]=='cd9b28f6f01e6d37aa8bb8436d6c8601f23da73eb23fddb5de923d82e74418f8';run('shell','am','start','-n',pkg+'/.MainActivity')
 elif sys.argv[1]=='tap':
