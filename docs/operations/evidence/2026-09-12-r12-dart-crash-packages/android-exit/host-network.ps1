...
$dir='C:\r12-android-exit-marker-20260912'
...
if($Phase -eq 'after'){$old=[IO.File]::ReadAllText('C:/r12-android-exit-marker-20260912/host-network-installed-before.json')|ConvertFrom-Json;$r.routes_match_before=$r.routes_sha256 -eq $old.routes_sha256;$r.dns_match_before=$r.dns_sha256 -eq $old.dns_sha256}
