...
$dir='C:/Users/Public/R126b20260912'
$old=[IO.File]::ReadAllText("$dir/expected.json")|ConvertFrom-Json
if($old.client_source -ne '2aa57015783ceb3415e3be62bbf0a698729011c4'){throw 'Wrong previous source'}
$matched=0
...
$r|ConvertTo-Json|Set-Content -LiteralPath "$dir/installed-after-launch.json" -Encoding UTF8
$r|ConvertTo-Json
