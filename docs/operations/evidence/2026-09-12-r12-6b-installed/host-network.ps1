...
$dir='C:\r12-6b-installed-20260912'
...
if($Phase -eq 'after'){$old=[IO.File]::ReadAllText("$dir/host-network-installed-before.json")|ConvertFrom-Json;$r.routes_match_before=$r.routes_sha256 -eq $old.routes_sha256;$r.dns_match_before=$r.dns_sha256 -eq $old.dns_sha256}
