...
dll = Path('E:/r12client/apps/windows_shell/build/release_bundle/pokrov-windows-x64-1.2.0+4053/pokrov-core.dll')
...
fixture = root / 'current-core-loopback-fixture'
fixture.mkdir()
...
(root / 'current-core-lifecycle.json').write_text(json.dumps(receipt, indent=2) + '\n', encoding='utf8')
origin.close()
