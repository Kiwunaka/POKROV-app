...
out = Path('C:/r12-marker-packages-20260912')
...
assert b'8067520c7b9230ab0c66823fae9ae78791f1a838' in (bundle/'data/app.so').read_bytes(), 'Current Dart revision absent'
...
result = {'schema': 'pokrov.r12.final-windows-package-audit/v1',
          'source_client': '8067520c7b9230ab0c66823fae9ae78791f1a838', 'source_core': '6b271decead88b708e2fc03984b703b0a4e63ebd',
