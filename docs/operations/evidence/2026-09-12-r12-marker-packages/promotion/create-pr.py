...
title='Preserve previous-exit marker when replacement fails'
client=signed('client','Kiwunaka/POKROV-app',Path('E:/r12client'),candidate,'codex/marker-atomicity-signed-20260912',title)
