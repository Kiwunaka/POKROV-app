...
$start.Arguments='-NoProfile -ExecutionPolicy Bypass -File C:/Users/Public/R12C05266220260912/ffi2662/child.ps1'
...
$result=[ordered]@{utc=[DateTime]::UtcNow.ToString('o');status=if($leaked){'FAIL_PRIVACY'}else{'PASS_BOUNDED_PACKAGE_FFI'};origin='current-origin owned Windows 11 VM';client_source='212bd2f30c9f91d80fd3a6c08fb5557be8457f1c';core_source='2662f76a3303a0518bb07fbbdc449c066de2f95b';packaged_dll_path='C:/Users/Public/R12C05266220260912/ffi2662/pokrov-core.dll';child=$child;sinks=$sinks;raw_streams_retained=$false;host_network_changed=$false;live_profile_used=$false}
