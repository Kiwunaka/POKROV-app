...
$dir='C:/r12-c05-installed-20260912'
...
if($Phase -eq 'after'){$old=[IO.File]::ReadAllText("$dir/host-network-resumed-before.json")|ConvertFrom-Json;$r.routes_match_before=$r.routes_sha256 -eq $old.routes_sha256;$r.dns_match_before=$r.dns_sha256 -eq $old.dns_sha256}
$r|ConvertTo-Json|Set-Content "$dir/host-network-resumed-$Phase.json" -Encoding UTF8
