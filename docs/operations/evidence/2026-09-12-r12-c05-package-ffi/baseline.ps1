...
$old=[IO.File]::ReadAllText("$dir/previous-expected.json")|ConvertFrom-Json
if($old.client_source -ne '7ed18c97c43ba39ce18701220d487af1b0c5a446'){throw 'Wrong previous source'}
$matched=0
...
if($matched -ne 304){throw 'Old installed package mismatch'}
...
$r|ConvertTo-Json|Set-Content -LiteralPath "$dir/baseline-resumed.json" -Encoding UTF8
$r|ConvertTo-Json
