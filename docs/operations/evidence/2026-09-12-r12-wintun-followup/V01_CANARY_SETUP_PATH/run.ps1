...
$root='C:/r12-c05-wintun-20260912/V01_CANARY_SETUP_PATH'
...
$start.Arguments='-NoProfile -ExecutionPolicy Bypass -File C:/r12-c05-wintun-20260912/V01_CANARY_SETUP_PATH/child.ps1'
