...
result={'status':'RUNNING','source':source,'core':'880bff65ad665844828fe50fc395e9cfc1cd81b4','utc':datetime.datetime.now(datetime.timezone.utc).isoformat(),'floor_bytes':floor,'abort_margin':64*2**20,'estimated_incremental_windows_budget_bytes':512*2**20,'previous_windows_output_bytes':255375313,'prior_outputs_retained':True,'skipped_build_script_checks':'Focused current runtime81 Android8 seed/docs already passed; full CI and native CTest separate','samples':[]}
