...
markers={'credentials':'V01_CANARY_CREDENTIAL_7bd2','config':'V01_CANARY_CONFIG_b861','url':'https://v01.invalid/private','ip':'203.0.113.71','path':'C:\\Users\\V01Fake\\private','pii':'v01@example.invalid'}
receipt=json.loads((out/'receipt.json').read_text(encoding='utf-8-sig'));assert receipt['status']=='PASS_BOUNDED_PACKAGE_FFI'
