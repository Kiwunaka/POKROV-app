...
`1.2.0+4051`/Core `cd8f0f4…884d` line is pre-candidate only. Older device or runtime passes
...
- The successor `1.2.0+4051` line binds secret-safe Core `cd8f0f4…884d`.
