...
abstract final class OperationalFailureMapper {
  ...
  static const Map<String, String> _runtimeCodes = <String, String>{
    ...
    'core_egress_dns_failed': 'DNS-002',
    'core_egress_connect_failed': 'EGRESS-001',
    'core_egress_tls_failed': 'TRANSPORT-004',
    'core_egress_tls_timeout': 'TRANSPORT-006',
    'core_egress_response_timeout': 'TRANSPORT-007',
