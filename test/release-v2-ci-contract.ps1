...
$requiredFragments = @(
  ...
  "ref: `${{ github.event_name == 'workflow_dispatch' && inputs.core_ref || github.event_name == 'pull_request' && github.event.pull_request.number == 105 && 'c8b0461c1975ef96e32024774300a5829b9fdc43' || 'main' }}",
  "fetch-depth: 0",
