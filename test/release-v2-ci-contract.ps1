...
$requiredFragments = @(
  ...
  "ref: `${{ github.event_name == 'workflow_dispatch' && inputs.core_ref || github.event_name == 'pull_request' && github.event.pull_request.number == 120 && '6b271decead88b708e2fc03984b703b0a4e63ebd' || 'main' }}",
  "fetch-depth: 0",
