...
$requiredFragments = @(
  ...
  "ref: `${{ github.event_name == 'workflow_dispatch' && inputs.core_ref || github.event_name == 'pull_request' && github.event.pull_request.number == 119 && '880bff65ad665844828fe50fc395e9cfc1cd81b4' || 'main' }}",
  "fetch-depth: 0",
