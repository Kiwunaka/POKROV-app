...
$expectedFiles = @(
  ...
  "apps\\linux_shell\\pubspec.yaml",
  "apps\\linux_shell\\lib\\main.dart",
  "apps\\linux_shell\\daemon\\go.mod",
  "apps\\linux_shell\\daemon\\cmd\\pokrov-linuxd\\main.go",
  "apps\\linux_shell\\packaging\\systemd\\pokrov-linuxd.service",
  "apps\\linux_shell\\packaging\\systemd\\pokrov-linuxd.socket",
  "apps\\linux_shell\\packaging\\polkit\\space.pokrov.linux.policy",
