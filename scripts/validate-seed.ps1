...
if (Test-Path -LiteralPath $runtimeArtifactsPath -PathType Leaf) {
  ...
  if ($runtimeArtifacts.core.source_commit -ne "904e440aca98cb6419744c5c04c83223a6d6380e") {
  ...
  if ($artifactProvenance.status -ne "clean_reproducible_pre_candidate_local" -or
      ...
      $artifactProvenance.reproducible_build.android.source_commit -ne "904e440aca98cb6419744c5c04c83223a6d6380e" -or
      [int64]$artifactProvenance.reproducible_build.android.size -ne 107493859 -or
      $artifactProvenance.reproducible_build.android.sha256 -ne "d2382adeeef8336721de6849b51d68d01576bbf9ae7c614a240bb18b9a4ea021" -or
      $artifactProvenance.reproducible_build.windows.result -ne "PASS_BYTE_IDENTICAL_TWO_BUILDS" -or
      $artifactProvenance.reproducible_build.windows.source_commit -ne "904e440aca98cb6419744c5c04c83223a6d6380e" -or
      [int64]$artifactProvenance.reproducible_build.windows.size -ne 55453184 -or
      $artifactProvenance.reproducible_build.windows.sha256 -ne "18c5bf90a4e710b4d262f92d9e93bb587c4718d9425af89e265304dfd3a16a3c" -or
  ...
  if ($artifactEvidence.android.result -ne "PASS_BYTE_IDENTICAL_TWO_BUILDS" -or
      $artifactEvidence.android.source_commit -ne "904e440aca98cb6419744c5c04c83223a6d6380e" -or
      $artifactEvidence.android.tree_sha256 -ne "f191e74b51d9bebab8f800aba66e4bc51e36548e0f78de4ab0ab2da9eb1326fb" -or
      $artifactEvidence.android.evidence_sha256 -ne "8eb6d4f60d2bf9ef922a85c369e5db269fb5ee448713e403ef11b7337cd77737" -or
      ...
      $artifactEvidence.windows.source_commit -ne "904e440aca98cb6419744c5c04c83223a6d6380e" -or
      $artifactEvidence.windows.tree_sha256 -ne "f72ab3e31c55830694af8dc1915565355ae51924fabbb300af90691fbb7fc60f" -or
      $artifactEvidence.windows.evidence_sha256 -ne "9c132c6165904d9de8bce87b11386ab4eafa53200e0976c0fd35e1ead5b644f2" -or
  ...
  if ($androidRuntime.entry -ne "pokrov-core.aar" -or
      ...
      $androidRuntime.source_commit -ne "904e440aca98cb6419744c5c04c83223a6d6380e" -or
      [int64]$androidRuntime.size -ne 107493859 -or
      $androidRuntime.sha256 -ne "d2382adeeef8336721de6849b51d68d01576bbf9ae7c614a240bb18b9a4ea021" -or
  ...
  if ($windowsRuntime.entry -ne "pokrov-core.dll" -or
      ...
      $windowsRuntime.source_commit -ne "904e440aca98cb6419744c5c04c83223a6d6380e" -or
      [int64]$windowsRuntime.size -ne 55453184 -or
      $windowsRuntime.sha256 -ne "18c5bf90a4e710b4d262f92d9e93bb587c4718d9425af89e265304dfd3a16a3c" -or
