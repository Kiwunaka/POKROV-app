...
FOUNDATION_EXPORT NSString* _Nonnull MobileBuildConfig(NSString* _Nullable path, NSString* _Nullable HiddifyOptionsJson, NSError* _Nullable* _Nullable error);
...
FOUNDATION_EXPORT BOOL MobileSetup(NSString* _Nullable baseDir, NSString* _Nullable workingDir, NSString* _Nullable tempDir, BOOL debug, NSError* _Nullable* _Nullable error);
